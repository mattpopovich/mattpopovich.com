...
You can also [apply for standby tickets](https://www.nbc.com/nbc-insider/how-to-get-SNL-tickets) at 10AM Thursdays before the show, but I'm not terribly familiar with how that works, so I won't try to explain it here.
...
### Checking in
You line up in front of a set of stairs (the "Grand Stair") closed off with glass doors. If you're lost, you can ask people that work there and they will direct you. There won't be anyone official looking there just yet, but if you ask the people in line, that can help confirm you're in the right spot. By around 8:55PM someone official will start directing traffic and telling you that this line is only for SNL guests with reservations, etc.
