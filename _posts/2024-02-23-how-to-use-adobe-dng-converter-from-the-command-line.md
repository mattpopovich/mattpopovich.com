...
> Note that this article assumes you have basic familiarity with the terminal and shell commands. If you are not familiar or would like to learn more, check out my post [here](https://mattpopovich.com/posts/introduction-to-the-command-line-shell-terminal-etc/) for an "Introduction to the Terminal / Shell / Command Line, etc.".
{: .prompt-warning }
