...
date: 2025-08-18 19:25:46 -0600
categories: [Blog, Not YouTube]    # <=2 values here: top category and sub category
tags: [apple, apple silicon, arm, audi, audi a3, audi a3 8v, big sur, catalina, how to, mac, monterey, not youtube, osx, sequoia, tech, tutorial, utm, volkswagen, vw, windows]                # TAG names should always be lowercase
...
2. Create a [Windows virtual machine (VM) on your Mac](/posts/how-to-run-windows-on-mac-via-utm)
3. Install [VCDS](https://www.ross-tech.com/vcds/download/current.php) in your Windows VM
4. If you plan on using your HEX-interface via USB, connect the USB device to your VM
5. Open up VCDS, go through the program options to [create a configuration for your device](https://youtu.be/tvh_5b5Gfqg?t=120)
...
![Diagram showing VCDS software --> HEX-interface (hardware) --> Vehicle](/assets/img/posts/2025-08-18-how-to-use-vcds-ross-tech-on-a-mac/VCDS-architecture.jpg)
...
!["USB Drivers for Legacy Interfaces" checkbox during VCDS installation](/assets/img/posts/2025-08-18-how-to-use-vcds-ross-tech-on-a-mac/VCDS-LegacyDrivers.png){: .shadow .w-50}
...
![Image with both VCDS lights blinking blue + Ross-Tech HEX-V2 connected via USB in the Mac's System Report](/assets/img/posts/2025-08-18-how-to-use-vcds-ross-tech-on-a-mac/successful_HEX-V2_connection_annotated.jpeg){: .shadow .w-75}
...
![Video demonstration that bending the cable at 90 degrees allows the HEX interface to be connected and restoring the cable to be straight loses USB connection](/assets/img/posts/2025-08-18-how-to-use-vcds-ross-tech-on-a-mac/HEX-V2_hardware-bad_cable.gif){: .shadow}
