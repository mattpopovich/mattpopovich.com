...
| Custom gestures can be made <br> while target app is on screen | No                                                   | Yes ✅                                  |
...
## Setting up [Voice Control](https://support.apple.com/guide/iphone/use-voice-control-iph2c21a3c88/ios)
   ...
   7. Add a name for the command to reply your recorded gestures, Ex. "auto click taps"
   8. 🗣️ "auto click taps"
      - Want to repeat? 🗣️ "Repeat 2 times"
   9.  🗣️ "turn off voice control"
      - This will turn off voice control at the **end** of the current custom gesture
...
## Setting up [Switch Control](https://support.apple.com/guide/iphone/intro-to-switch-control-iphc9d32b862/ios)
   ...
   5. Triple click [side button](https://support.apple.com/en-us/105103) (the button that turns off or locks your phone), or physical home button if you have it
...
<u>Voice control</u>: Saying "turn off voice control" will exit **after** the current custom gesture finishes. Until then, you can lock the screen, tap the screen to interact with it, or even say 🗣️ "reboot device" if you are in a major pickle.
...
Voice control list of commands: https://gist.github.com/willwade/807cd631bc494039ed58b5f8304e8883
-->
...
src="https://open.spotify.com/embed/track/1p6oIkblnSDgYd9CShEuOa?utm_source=generator"
