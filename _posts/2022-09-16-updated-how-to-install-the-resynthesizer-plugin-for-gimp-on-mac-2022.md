...
tags: [youtube, GIMP, resynthesizer, tech, tutorial, how to, apple, mac os, update]       # TAG names should always be lowercase
layout: post
pin: false
toc: true
comments: true
