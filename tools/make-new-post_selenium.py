...
# Using selenium because the url contains Javascript
...
# Modified to use webdriver instead of HTMLSession() as I couldn't get that working
def get_video_info(url):
    options = webdriver.FirefoxOptions()
    options.add_argument("--headless")
    # TODO: Pass in executable_path via Service object
